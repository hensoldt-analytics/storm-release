...
class JavaObject(object):
    ...
    thrift_spec = (
        ...
        (2, TType.LIST, 'args_list', (TType.STRUCT, (JavaObjectArg, JavaObjectArg.thrift_spec), False), None, ),  # 2
    )
...
class ComponentCommon(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.MAP, 'inputs', (TType.STRUCT, (GlobalStreamId, GlobalStreamId.thrift_spec), TType.STRUCT, (Grouping, Grouping.thrift_spec), False), None, ),  # 1
        (2, TType.MAP, 'streams', (TType.STRING, 'UTF8', TType.STRUCT, (StreamInfo, StreamInfo.thrift_spec), False), None, ),  # 2
...
class StormTopology(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.MAP, 'spouts', (TType.STRING, 'UTF8', TType.STRUCT, (SpoutSpec, SpoutSpec.thrift_spec), False), None, ),  # 1
        (2, TType.MAP, 'bolts', (TType.STRING, 'UTF8', TType.STRUCT, (Bolt, Bolt.thrift_spec), False), None, ),  # 2
        (3, TType.MAP, 'state_spouts', (TType.STRING, 'UTF8', TType.STRUCT, (StateSpoutSpec, StateSpoutSpec.thrift_spec), False), None, ),  # 3
...
class ClusterSummary(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.LIST, 'supervisors', (TType.STRUCT, (SupervisorSummary, SupervisorSummary.thrift_spec), False), None, ),  # 1
        (2, TType.I32, 'nimbus_uptime_secs', None, 0, ),  # 2
        (3, TType.LIST, 'topologies', (TType.STRUCT, (TopologySummary, TopologySummary.thrift_spec), False), None, ),  # 3
        (4, TType.LIST, 'nimbuses', (TType.STRUCT, (NimbusSummary, NimbusSummary.thrift_spec), False), None, ),  # 4
    )
...
class BoltStats(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.MAP, 'acked', (TType.STRING, 'UTF8', TType.MAP, (TType.STRUCT, (GlobalStreamId, GlobalStreamId.thrift_spec), TType.I64, None, False), False), None, ),  # 1
        (2, TType.MAP, 'failed', (TType.STRING, 'UTF8', TType.MAP, (TType.STRUCT, (GlobalStreamId, GlobalStreamId.thrift_spec), TType.I64, None, False), False), None, ),  # 2
        (3, TType.MAP, 'process_ms_avg', (TType.STRING, 'UTF8', TType.MAP, (TType.STRUCT, (GlobalStreamId, GlobalStreamId.thrift_spec), TType.DOUBLE, None, False), False), None, ),  # 3
        (4, TType.MAP, 'executed', (TType.STRING, 'UTF8', TType.MAP, (TType.STRUCT, (GlobalStreamId, GlobalStreamId.thrift_spec), TType.I64, None, False), False), None, ),  # 4
        (5, TType.MAP, 'execute_ms_avg', (TType.STRING, 'UTF8', TType.MAP, (TType.STRUCT, (GlobalStreamId, GlobalStreamId.thrift_spec), TType.DOUBLE, None, False), False), None, ),  # 5
    )
...
class TopologyInfo(object):
    ...
    thrift_spec = (
        ...
        (2, TType.STRING, 'name', 'UTF8', None, ),  # 2
        (3, TType.I32, 'uptime_secs', None, None, ),  # 3
        (4, TType.LIST, 'executors', (TType.STRUCT, (ExecutorSummary, ExecutorSummary.thrift_spec), False), None, ),  # 4
        (5, TType.STRING, 'status', 'UTF8', None, ),  # 5
        (6, TType.MAP, 'errors', (TType.STRING, 'UTF8', TType.LIST, (TType.STRUCT, (ErrorInfo, ErrorInfo.thrift_spec), False), False), None, ),  # 6
        (7, TType.MAP, 'component_debug', (TType.STRING, 'UTF8', TType.STRUCT, (DebugOptions, DebugOptions.thrift_spec), False), None, ),  # 7
        None,  # 8
        None,  # 9
        None,  # 10
        None,  # 11
...
class SupervisorPageInfo(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.LIST, 'supervisor_summaries', (TType.STRUCT, (SupervisorSummary, SupervisorSummary.thrift_spec), False), None, ),  # 1
        (2, TType.LIST, 'worker_summaries', (TType.STRUCT, (WorkerSummary, WorkerSummary.thrift_spec), False), None, ),  # 2
    )
...
class TopologyPageInfo(object):
    ...
    thrift_spec = (
        ...
        (9, TType.MAP, 'id_to_spout_agg_stats', (TType.STRING, 'UTF8', TType.STRUCT, (ComponentAggregateStats, ComponentAggregateStats.thrift_spec), False), None, ),  # 9
        (10, TType.MAP, 'id_to_bolt_agg_stats', (TType.STRING, 'UTF8', TType.STRUCT, (ComponentAggregateStats, ComponentAggregateStats.thrift_spec), False), None, ),  # 10
        ...
        (16, TType.LIST, 'workers', (TType.STRUCT, (WorkerSummary, WorkerSummary.thrift_spec), False), None, ),  # 16
        None,  # 17
        None,  # 18
        None,  # 19
        None,  # 20
...
class ComponentPageInfo(object):
    ...
    thrift_spec = (
        ...
        (7, TType.MAP, 'window_to_stats', (TType.STRING, 'UTF8', TType.STRUCT, (ComponentAggregateStats, ComponentAggregateStats.thrift_spec), False), None, ),  # 7
        (8, TType.MAP, 'gsid_to_input_stats', (TType.STRUCT, (GlobalStreamId, GlobalStreamId.thrift_spec), TType.STRUCT, (ComponentAggregateStats, ComponentAggregateStats.thrift_spec), False), None, ),  # 8
        (9, TType.MAP, 'sid_to_output_stats', (TType.STRING, 'UTF8', TType.STRUCT, (ComponentAggregateStats, ComponentAggregateStats.thrift_spec), False), None, ),  # 9
        (10, TType.LIST, 'exec_stats', (TType.STRUCT, (ExecutorAggregateStats, ExecutorAggregateStats.thrift_spec), False), None, ),  # 10
        (11, TType.LIST, 'errors', (TType.STRUCT, (ErrorInfo, ErrorInfo.thrift_spec), False), None, ),  # 11
...
class SettableBlobMeta(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.LIST, 'acl', (TType.STRUCT, (AccessControl, AccessControl.thrift_spec), False), None, ),  # 1
...
class StormBase(object):
    ...
    thrift_spec = (
        ...
        (9, TType.MAP, 'component_debug', (TType.STRING, 'UTF8', TType.STRUCT, (DebugOptions, DebugOptions.thrift_spec), False), None, ),  # 9
...
class ClusterWorkerHeartbeat(object):
    ...
    thrift_spec = (
        ...
        (2, TType.MAP, 'executor_stats', (TType.STRUCT, (ExecutorInfo, ExecutorInfo.thrift_spec), TType.STRUCT, (ExecutorStats, ExecutorStats.thrift_spec), False), None, ),  # 2
...
class LocalStateData(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.MAP, 'serialized_parts', (TType.STRING, 'UTF8', TType.STRUCT, (ThriftSerializedObject, ThriftSerializedObject.thrift_spec), False), None, ),  # 1
    )
...
class LocalAssignment(object):
    ...
    thrift_spec = (
        ...
        (2, TType.LIST, 'executors', (TType.STRUCT, (ExecutorInfo, ExecutorInfo.thrift_spec), False), None, ),  # 2
...
class LSSupervisorAssignments(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.MAP, 'assignments', (TType.I32, None, TType.STRUCT, (LocalAssignment, LocalAssignment.thrift_spec), False), None, ),  # 1
    )
...
class LSWorkerHeartbeat(object):
    ...
    thrift_spec = (
        ...
        (3, TType.LIST, 'executors', (TType.STRUCT, (ExecutorInfo, ExecutorInfo.thrift_spec), False), None, ),  # 3
        (4, TType.I32, 'port', None, None, ),  # 4
    )
...
class LSTopoHistoryList(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.LIST, 'topo_history', (TType.STRUCT, (LSTopoHistory, LSTopoHistory.thrift_spec), False), None, ),  # 1
    )
...
class LogConfig(object):
    ...
    thrift_spec = (
        None,  # 0
        None,  # 1
        (2, TType.MAP, 'named_logger_level', (TType.STRING, 'UTF8', TType.STRUCT, (LogLevel, LogLevel.thrift_spec), False), None, ),  # 2
    )
...
class HBRecords(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.LIST, 'pulses', (TType.STRUCT, (HBPulse, HBPulse.thrift_spec), False), None, ),  # 1
    )
